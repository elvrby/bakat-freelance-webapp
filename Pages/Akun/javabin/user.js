 ...
 postinganMenu4.addEventListener('click', function() {
     ...
     document.getElementById('kafka-image').addEventListener('click', function(event) {
     ...
     document.getElementById('m-settings-nav-show').addEventListener('click', function(event) {
         event.stopPropagation(); // Menghentikan event dari mempropagasi ke parent elements
 ...
 document.addEventListener('click', function(event) {
     ...
     if (!event.target.closest('.display-post-feed') && !event.target.closest('.Des-User-Post')) {
 ...
 document.addEventListener('click', function(event) {
     ...
     if (!event.target.closest('.display-reels-feed') && !event.target.closest('.Des-User-Reels')) {
 ...
 document.addEventListener("DOMContentLoaded", function() {
    ...
    const iklanBar = document.getElementById("iklanBar");

    // Tampilkan atau sembunyikan iklan-bar ketika tombol diklik
    toggleButton.addEventListener("click", function() {
        if (iklanBar.style.display === "none" || iklanBar.style.display === "") {
            iklanBar.style.display = "block";
        } else {
            iklanBar.style.display = "none";
        }
    });

    // Sembunyikan iklan-bar ketika area di luar iklan-bar diklik
    document.addEventListener("click", function(event) {
        if (!iklanBar.contains(event.target) && event.target !== toggleButton) {
            iklanBar.style.display = "none";
        }
    });

    // Sembunyikan iklan-bar ketika pengguna menggulir layar di perangkat mobile
    window.addEventListener("scroll", function() {
        iklanBar.style.display = "none";
    });

    // Sembunyikan iklan-bar ketika pengguna menyentuh area di luar iklan-bar di perangkat mobile
 ...
 document.querySelector('.display-reels-feed').addEventListener('transitionend', pauseVideo);
 ...
 document.getElementById("reels-feed-mobile-close").addEventListener("click", function() {
     video.pause();
 });
